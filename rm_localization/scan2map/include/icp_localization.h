...
private:
    ...
    ros::Subscriber initialpose_subscriber_;        //unuse
...
//////////////////////////////////////////////////////////////////////
    ...
    void Scan2PointCloud(const sensor_msgs::LaserScan::ConstPtr &scan_msg, PointCloudT::Ptr &cloud_msg);
