...
int main(int argc, char** argv)
{
  ...
  //  private_nh.param("file_directory", file_directory, std::string("/home/ares_yt/ws_livox/src/LIO-Lite/src/LIO-Lite/maps/split_map/"));
   private_nh.param("file_directory", file_directory, std::string("/home/ares_yt/ws_livox/src/Point-LIO/PCD/"));
   ROS_INFO("*** file_directory = %s ***\n", file_directory.c_str());

   private_nh.param("file_name", file_name, std::string("scans"));
  //  private_nh.param("file_name", file_name, std::string("-1_-1"));
